  ...
  return (
    <main className="flex flex-col justify-center items-center h-[80vh]">
      ...
      <div className="flex justify-center mt-32">
        <img src={category.imageUrl} alt="logo" className="w-1/2 rounded-full" />
      </div>
      ...
      <div className="mt-32">
          <svg aria-hidden="true" className="w-16 h-16 mr-2 text-gray-200 animate-spin dark:text-gray-300 fill-[#0470c2]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
